class Tables {
  ...
  createProduct() {
    const sql =
      "CREATE TABLE IF NOT EXISTS product (id int NOT NULL AUTO_INCREMENT, product varchar(30) NOT NULL, price varchar(20) NOT NULL, brand varchar(20) NOT NULL, description text NOT NULL, inserted_by varchar(30) NOT NULL, PRIMARY KEY(id))";
