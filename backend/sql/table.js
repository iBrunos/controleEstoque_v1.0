class Tables {
  ...
  createProduct() {
    const sql =
      "CREATE TABLE IF NOT EXISTS products (id int NOT NULL AUTO_INCREMENT, product varchar(255) NOT NULL, price varchar(20) NOT NULL, brand varchar(20) NOT NULL, description text NOT NULL, inserted_by varchar(30) NOT NULL, PRIMARY KEY(id))";
  ...
  createStock() {
    const sql =
      "CREATE TABLE IF NOT EXISTS stock (id INT PRIMARY KEY AUTO_INCREMENT,product_id INT NOT NULL,product VARCHAR(20) NOT NULL,quantity INT NOT NULL,created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,updated_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, FOREIGN KEY (product_id) REFERENCES products(id) ON DELETE CASCADE)";
  ...
  createEntrys() {
    const sql =
    "CREATE TABLE IF NOT EXISTS entrys (id int NOT NULL AUTO_INCREMENT,product varchar(30) NOT NULL,observation text NOT NULL,amount int NOT NULL,entry_price VARCHAR(255) NOT NULL,inserted_by varchar(30) NOT NULL, type Varchar(15), created_at timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,updated_at timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,PRIMARY KEY(id))";
  ...
  createExits() {
    const sql =
    "CREATE TABLE IF NOT EXISTS exits (id int NOT NULL AUTO_INCREMENT,product varchar(30) NOT NULL,observation text NOT NULL,amount int NOT NULL,exit_price VARCHAR(255) NOT NULL,inserted_by varchar(30) NOT NULL, type Varchar(15), created_at timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,updated_at timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,PRIMARY KEY(id))";
