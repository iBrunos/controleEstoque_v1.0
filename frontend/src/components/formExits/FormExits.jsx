...
export default function FormProducts2() {
  ...
  return (
    <>
      <Header />
      <form onSubmit={editingItem !== null ? updateItem : addItem} className='flex flex-row mb-0 mt-1 bg-white border-b-gray-200 border-b pl-32 pt-1 pb-2 ml-0'>
        ...
        <input type="text" value={description} placeholder='Descrição' onChange={e => setDescription(e.target.value)} className='mr-2 border-gray-300 border rounded-md p-2 w-[25rem] outline-none appearance-none placeholder-gray-500 text-gray-500' />
        <input type="text" value={amount} placeholder='Quantidade' onChange={e => setAmount(e.target.value)} className='mr-2 border-gray-300 border rounded-md p-2 w-[6.5rem] outline-none appearance-none placeholder-gray-500 text-gray-500' />
        <button type="submit" className='mr-16 border rounded-md  p-2 bg-pink-500 text-white font-medium'>{editingItem !== null ? 'Editar Produto' : 'Adicionar Produto'}</button>
      ...
      <section className="bg-white text-gray-600 font-medium">
        <div className='flex'>
